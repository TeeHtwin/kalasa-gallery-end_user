  ...
  return (
    <section className="text-primary px-20 max-w-[1600px] m-auto py-20">
      <div className="flex justify-between items-center">
        <p className="font-serif font-light text-xl sm:text-4xl md:text-5xl lg:text-6xl">Our Blogs</p>
        <div className="relative hidden md:block">
          <input
            type="search"
            className="block sm:w-64 md:w-96 lg:w-[666px] p-4 ps-10 text-sm border-primary border placeholder:text-primary outline-none"
        ...
        {blogs.map((blog) => (
          ...
          >
            ...
            <div className="py-3 px-3">
              ...
              <button className="pt-5 text-lg font-sans font-medium">Read more →</button>
            </div>
          </div>
        ))}
      </div>
